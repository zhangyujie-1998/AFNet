...
def parse_args():
    ...
    parser.add_argument('--data_dir_texture', default='', type=str, help = 'path to the images')
    parser.add_argument('--data_dir_depth', default='', type=str, help = 'path to the depth maps')
    parser.add_argument('--data_dir_mask', default='', type=str, help = 'path to the mask maps')
